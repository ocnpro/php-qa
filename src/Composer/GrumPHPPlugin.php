...
{
    private const PACKAGE_NAME = 'php-qa/grumphp';
    ...
    public function detectGrumphpAction(PackageEvent $event): void
    {
        ...
        // Check all PhpQa operations to see if they are unanimously removing PhpQa
    ...
    {
        $this->io->writeError('<fg=red>PhpQa can not sniff your commits! ('.$reason.')</fg=red>');
    }
}
