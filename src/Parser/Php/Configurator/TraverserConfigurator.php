...
namespace PhpQa\Parser\Php\Configurator;

use PhpQa\Exception\RuntimeException;
use PhpQa\Parser\Php\Context\ParserContext;
use PhpQa\Parser\Php\Visitor\ConfigurableVisitorInterface;
use PhpQa\Parser\Php\Visitor\ContextAwareVisitorInterface;
