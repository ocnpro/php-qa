...
namespace PhpQa\Util;

use PhpQa\Configuration\GuessedPaths;
...
class Paths
{
     ...
     */
    public function getPhpQaExecutableRootDir(): string
    {
    ...
    {
        return $this->filesystem->buildPath($this->getPhpQaExecutableRootDir(), 'resources');
    }
