...
namespace PhpQa\Console\Command\Git;

use PhpQa\Collection\FilesCollection;
use PhpQa\Collection\TestSuiteCollection;
use PhpQa\IO\ConsoleIO;
use PhpQa\Locator\ChangedFiles;
use PhpQa\Locator\StdInFiles;
use PhpQa\Runner\TaskRunner;
use PhpQa\Runner\TaskRunnerContext;
use PhpQa\Task\Context\GitCommitMsgContext;
...
class CommitMsgCommand extends Command
{
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<fg=yellow>PhpQa detected a commit-msg command.</fg=yellow>');
