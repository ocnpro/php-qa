...
use PhpQa\Configuration\Environment\DotEnvSerializer;
use PhpQa\Configuration\Model\HooksConfig;
...
class InitCommand extends Command
{
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<fg=yellow>Watch out! PhpQa is sniffing your commits!<fg=yellow>');
    ...
    /**
     * @throws \PhpQa\Exception\FileNotFoundException
     */
